...
admin.site.site_header = "USREC"
admin.site.site_title = "USREC Admin Portal"
admin.site.index_title = "USREC Admin"

# swagger
api_info = openapi.Info(
    title="USREC API",
    default_version="v1",
    description="API documentation for USREC App",
)
